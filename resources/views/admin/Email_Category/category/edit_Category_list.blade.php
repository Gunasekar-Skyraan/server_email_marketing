                            ...
                            <div class="card-body py-md-30">
                                <div class="horizontal-form">
                                  @foreach ($edit_category_id as $edit_category_id)
                                    <form action="{{url('admin/edit_category_list/'.$edit_category_id->id)}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" name="editcatname" id="editcatname" value="{{$edit_category_id->category_name}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                          <div class="col-sm-3">
