...
<head>
    ...
    <title>Email Marketing - Add SUb Category</title>
                        ...
                        <div class="card card-horizontal card-default card-md mb-4">
                            ...
                            <div class="card-body py-md-30">
                                <div class="horizontal-form">
                                    <form  action="{{url('admin/insert_sub_category')}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                          ...
                                          <div class="col-sm-9">
                                            <div class="select-style2">
                                              <div class="atbd-select">
                                                  <select name="select-alerts2" id="select-search" class="form-control ">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="SubCategoryName" name="SubCategoryName" placeholder="Sub Category name" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                          <div class="col-sm-3">
