                            ...
                            <div class="card-body py-md-30">
                                <div class="horizontal-form">
                                  @foreach ($edit_sub_category_id as $edit)
                                    <form role="form" class="forms-sample" action="{{url('admin/edit_sub_category_list/'.$edit->id)}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                          ...
                                          <div class="col-sm-9">
                                            <div class="select-style2">
                                              <div class="atbd-select ">
                                                  <select name="select-alerts2" id="select-searcg" class="form-control ">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                              <div class="layout-button mt-25">
                                                  <input type="button" class="btn btn-default btn-squared border-normal bg-normal px-20" onclick="window.location.href='{{url('admin/sub_category_list')}}'" value="Cancel">
