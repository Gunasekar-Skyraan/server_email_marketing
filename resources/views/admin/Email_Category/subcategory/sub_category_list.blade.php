                        ...
                        <div class="col-lg-12">
                            <div class="breadcrumb-main">
                              ...
                              <div class="action-btn">
                                <a href="{{url('admin/add_sub_category')}}" class="btn btn-sm btn-primary btn-add">
                                                  ...
                                                  <td>
                                                    <div class="dropdown dropdown-click" style="padding-left: 25px;">
                                                      ...
                                                      <div class="dropdown-default dropdown-menu bg-dark">
                                                          <div class="dropdown-item" style="padding-left:55px !important;"><form action={{url("admin/edit_sub_category/".$sub_category->id)}} method="POST">
                                                            {{csrf_field()}}
                                                          ...
                                                          <div class="dropdown-item" style="padding-left:50px !important;"><form action={{url("admin/delete_sub_category/".$sub_category->id)}} method="POST"  style="padding-left:5px;">
                                                            {{csrf_field()}}
