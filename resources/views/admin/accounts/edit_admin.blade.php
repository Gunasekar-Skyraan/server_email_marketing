...
<html lang="en" dir="ltr">
  <head>
      ...
      <title>Email Marketing - Edit Admin</title>
                          ...
                          <form class="forms-sample" action="{{url('/admin/edit_admin_list/'.$edit->id)}}" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-3">
                              <div class="col-sm-3 d-flex aling-items-center">
                                <label for="parent" class=" col-form-label color-dark fs-14 fw-500 align-center">Admin Type<span style="color:red;">&nbsp;*</span></label>
                              </div>
                              <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                  <input type="text" class="form-control"  name="name" id="name" placeholder="Enter a name" value="{{$edit->name}}"/>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                  <input type="text" class="form-control" name="email" id="email" placeholder="Enter a Email" value="{{$edit->email}}" >
                              </div>
                            </div>
                              ...
                              <div class="col-sm-9">
                                <div class="card">
                                  <div class="card-body">
                                    ...
                                    @php $lists = explode('|',$edit->access_list);@endphp
                                    @foreach($array_2 as $array_2)
                                    <div class="form-check-inline h5 text-dark">

                                      @if(in_array($array_2, $lists))
                                      <input class="form-check-input bg-outline-dark border-3" type="checkbox" id="image_1{{$array_2}}" name="list[]" value="{{$array_2}}" checked  style="font-size: 80%;padding-left:5px;">
                                    ...
                                    @foreach($module as $row)
                                      <div class="form-check-inline h5 text-dark">
                                        @if(in_array($row->module_name,$module_1))
                                          <input class="form-check-input bg-outline-dark border-3" type="checkbox" id="image_1{{$row->module_name}}" name="model[]" value="{{$row->module_name}}" checked  style="font-size: 80%;padding-left:5px;">
                                          <label class="form-check-label" for="image_1{{$row->module_name}}" style="font-size: 80%;padding-left:5px;">{{$row->module_name}}</label>
                                        @else
                                          <input class="form-check-input bg-outline-dark border-3" type="checkbox" id="image_1{{$row->module_name}}" name="model[]" value="{{$row->module_name}}"  style="font-size: 80%;padding-left:5px;">
                                          <label class="form-check-label" for="image_1{{$row  ->module_name}}" style="font-size: 80%;padding-left:5px;"> {{$row->module_name}}</label>
                                        @endif
                                      </div>
                                    @endforeach
                                ...
                                <div class="card">
                                  <div class="card-body">
                                    ...
                                    <div class="form-check-inline h5 text-dark">
                                      ...
                                      <input class="form-check-input bg-outline-dark border-3" type="checkbox" id="image_1{{$arr}}" name="privileges[]" value="{{$arr}}" checked  style="font-size: 80%;padding-left:5px;">
                                        <label class="form-check-label" for="image_1{{$arr}}" style="font-size: 80%;padding-left:5px;">
                                        {{$arr}}
                                      </label>
                                      @else
                                        <input class="form-check-input bg-outline-dark border-3" type="checkbox" id="image_1{{$arr}}" name="privileges[]" value="{{$arr}}"  style="font-size: 80%;padding-left:5px;">
                                        <label class="form-check-label" for="image_1{{$arr}}" style="font-size: 80%;padding-left:5px;">
                                        {{$arr}}
                                        </label>
                                      @endif
