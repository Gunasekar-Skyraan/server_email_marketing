...
<head>
    ...
    <title>Email Marketing - Profile Update</title>
                                      ...
                                      <div class="form-group row mb-25">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="with-icon">
                                                    ...
                                                    <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light" id="inputNameIcon" name="name" value="{{Auth::guard('admin')->user()->name}}" placeholder="Duran Clayton">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-25">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="with-icon">
                                                    ...
                                                    <input type="email" class="form-control  ih-medium ip-gray radius-xs b-light" id="inputEmailIcon" value="{{Auth::guard('admin')->user()->email}}" name="email">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-25">
                                            <div class="col-sm-3 d-flex aling-items-center">
                                              <label for="password_confirmation" class="col-form-label color-dark fs-14 fw-500 align-center" >Password Changed <span style="color:red;">&nbsp;*</span></label>
                                            </div>
                                            <div class="col-sm-9">
                                            <div class="checkbox-theme-default custom-checkbox">
                                              <input class="checkbox toggle" id="check" type="checkbox" name="checkbox"><label for="check">
                                                <span class="checkbox-text">change</span>
                                              </label>
                                            </div>
                                          </div>
                                        </div>
                                        <div id="Normal">
                                          <div class="form-group row mb-25">
                                            ...
                                            <div class="col-sm-9">
                                              <div class="with-icon">
                                                ...
                                                <input type="text" class="form-control ih-medium ip-gray radius-xs b-light" id ="password" name="password" placeholder="Enter a Password">
                                              </div>
                                            </div>
                                          </div>
                                          <br>
                                          <div class="form-group row mb-25">
                                            <div class="col-sm-3 d-flex aling-items-center">
                                              <label for="password_confirmation" class="col-form-label color-dark fs-14 fw-500 align-center">Password Change<span style="color:red;">&nbsp;*</span></label>
                                            </div>
                                            <div class="col-sm-9">
                                              <div class="with-icon">
                                                <span class="las la-lock color-gray"></span>
                                                <input type="text" class="form-control ih-medium ip-gray radius-xs b-light"  id="password_confirmation" name="password_confirmation" placeholder="Enter a confirm Password">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="form-group row mb-25">
                                          <div class="col-sm-3 d-flex aling-items-center">
                                            <label for="file" class="col-form-label color-dark fs-14 fw-500 align-center">Profile Image</label>
                                          </div>
                                          <div class="col-sm-9">
                                              <div class="custom-file">
                                                <input class="form-control" type="file" id="file" name="file" placeholder="Choose File" accept="image/*">
                                              </div>
                                          </div>
                                        </div>
                                        <div class="form-group row mb-0">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="layout-button mt-25">
                                                    <a href="{{url('admin/app_list')}}" class="btn btn-default btn-squared border-normal bg-normal px-20 ">cancel</a>
