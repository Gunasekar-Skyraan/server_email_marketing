...
<head>
    ...
    <title>Email Marketing - Add Emails</title>
                      ...
                      <div class="col-lg-12">
                        <div class="card card-horizontal card-default card-md mb-4">
                            <div class="card-header">
                                <h6>Add Source Email</h6>
                            </div>
                            <div class="card-body py-md-30">
                                <div class="horizontal-form">
                                    <form action="{{url('admin/emails.insert')}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control ih-medium ip-light radius-xs b-light px-15" id="Email_name" name="Email_name" placeholder="Email name" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                          <div class="col-sm-3 d-flex aling-items-center">
                                              <label for="website_name" class=" col-form-label color-dark fs-14 fw-500 align-center">Website Name <span style="color:#405189;"> (optional)</span></label>
                                          </div>
                                          <div class="col-sm-9">
                                            <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="website_name" name="website_name" placeholder="website name" autocomplete="off">                                          </div>
                                        </div>

                                        <div class="form-group row">
                                          <div class="col-sm-3 d-flex aling-items-center">
                                              <label for="person_name" class=" col-form-label color-dark fs-14 fw-500 align-center">Person Name <span style="color:#405189;">(optional)</span></label>
                                          </div>
                                          <div class="col-sm-9">
                                            <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="person_name" name="person_name" placeholder="person name" autocomplete="off">                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                            <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="mail_host" name="mail_host" placeholder="Mail Host" autocomplete="off">                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                            <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="user_name" name="user_name" placeholder="User Name " autocomplete="off">                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                            <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="password" name="password" placeholder="Password" autocomplete="off">                                          </div>
                                        </div>
