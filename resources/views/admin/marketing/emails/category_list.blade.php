...
<head>
    ...
    <title>Email Marketing - Source Email List</title>
                        ...
                        <div class="col-lg-12">
                            <div class="breadcrumb-main">
                              ...
                              <div class="action-btn">
                                <a href="{{url('admin/add_emails')}}" class="btn btn-sm btn-primary btn-add">
                                  <i class="la la-plus"></i> Add New emails</a>
                              </div>
                            </div>
                        </div>
                    </div>
                                      ...
                                      <table id="members_list" class="table mb-0 table-bordered">
                                          <thead>
                                              <tr class="userDatatable-header">
                                                  ...
                                                  <th>
                                                      <span class="userDatatable-title">Website Name</span>
                                                  </th>
                                                  <th>
                                                      <span class="userDatatable-title">Person Name</span>
                                                  </th>
                                                  <th>
                                              ...
                                              <tr>
                                                              ...
                                                              <div class="checkbox-group-wrapper">
                                                                  <div class="checkbox-group d-flex">
                                                                      <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                                          <input class="checkbox" type="checkbox" id="check-grp-{{$emails->id}}">
                                                                          <label for="check-grp-{{$emails->id}}"></label>
                                                                      </div>
                                                                  </div>
                                                              </div>
                                                          </div>
                                                  ...
                                                  <td>
                                                    <div class="userDatatable-inline-title">
                                                      <h6>{{$emails->email_id}}</h6>
                                                  </div>
                                                  </td>
                                                  <td>
                                                    <div class="userDatatable-content">
                                                      <a href="{{$emails->website_name}}" class="text-dark fw-500">
                                                        {{$emails->website_name}}
                                                      </a>
                                                    </div>
                                                  </td>
                                                  ...
                                                  <td>
                                                      <div class="userDatatable-content">
                                                         {{date('d-m-Y', strtotime($emails->created_at))}}
                                                      </div>
                                                  </td>
                                                  <td>
                                                      <div class="userDatatable-content d-inline-block">
                                                        @if($emails->is_active == '0')
                                                    ...
                                                    <div class="dropdown dropdown-click" style="padding-left: 25px;">
                                                      ...
                                                      <div class="dropdown-default dropdown-menu bg-dark">
                                                        <div class="dropdown-item" style="padding-left:55px !important;">
                                                            <form action={{url("admin/edit_emails/".$emails->id)}} method="POST">
                                                                {{csrf_field()}}
                                                                <button  type="submit" class="btn btn-icon btn-circle btn-outline-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit emails"><span data-feather="edit"></span></button>
                                                            </form>
                                                        </div>
                                                        <div class="dropdown-item" style="padding-left:50px !important;">
                                                            <form action={{url("admin/delete_emails/".$emails->id)}} method="POST" style="padding-left:5px;">
                                                              {{csrf_field()}}
                                                              <button  type="submit" class="btn btn-icon btn-circle btn-outline-danger" onclick="return confirm('Are you sure you want to delete this item?');" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete emails"><span data-feather="trash-2"></span></button>
                                                            </form>
                                                        </div>
                                                      </div>
                                                    </div>
                                                  ...
                                                  <td>
                                                    <form action="{{url('admin/emails_status_update')}}" method="POST">
                                                      @csrf
                                                      <input type="hidden" name="cat_id" value="{{$emails->id}}">
                                                      @if($emails->is_active == '0')
