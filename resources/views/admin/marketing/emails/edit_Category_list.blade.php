...
<head>
    ...
    <title>Email Marketing - Edit Email</title>
                            ...
                            <div class="card-body py-md-30">
                                <div class="horizontal-form">
                                  @foreach ($edit_category_id as $edit_category_id)
                                    <form action="{{url('admin/edit_emails_list/'.$edit_category_id->id)}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                      <div class="form-group row">
                                        <div class="col-sm-3 d-flex aling-items-center">
                                            <label for="Email_name" class=" col-form-label color-dark fs-14 fw-500 align-center">Email Address <span style="color:red;">&nbsp;*</span></label>
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control ih-medium ip-light radius-xs b-light px-15" id="Email_name" value="{{$edit_category_id->email_id}}"  name="Email_name" placeholder="Email name" autocomplete="off">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <div class="col-sm-3 d-flex aling-items-center">
                                            <label for="website_name" class=" col-form-label color-dark fs-14 fw-500 align-center">Website Name </label>
                                        </div>
                                        <div class="col-sm-9">
                                          <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="website_name" value="{{$edit_category_id->website_name}}" name="website_name" placeholder="website name" autocomplete="off">                                          </div>
                                      </div>

                                      <div class="form-group row">
                                        <div class="col-sm-3 d-flex aling-items-center">
                                            <label for="person_name" class=" col-form-label color-dark fs-14 fw-500 align-center">Person Name </label>
                                        </div>
                                        <div class="col-sm-9">
                                          <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="person_name" value="{{$edit_category_id->person_name}}" name="person_name" placeholder="person name" autocomplete="off">                                          </div>
                                      </div>


                                      <div class="form-group row">
                                        <div class="col-sm-3 d-flex aling-items-center">
                                            <label for="mail_host" class=" col-form-label color-dark fs-14 fw-500 align-center">Mail Host <span style="color:red;">&nbsp;*</span></label>
                                        </div>
                                        <div class="col-sm-9">
                                          <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="mail_host" name="mail_host" value="{{$edit_category_id->mail_host}}" placeholder="Mail Host" autocomplete="off">                                          
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row">
                                        <div class="col-sm-3 d-flex aling-items-center">
                                            <label for="user_name" class=" col-form-label color-dark fs-14 fw-500 align-center">User Name <span style="color:red;">&nbsp;*</span></label>
                                        </div>
                                        <div class="col-sm-9">
                                          <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="user_name" name="user_name"  value="{{$edit_category_id->user_name}}" placeholder="User Name " autocomplete="off">                                          
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row">
                                        <div class="col-sm-3 d-flex aling-items-center">
                                            <label for="password" class=" col-form-label color-dark fs-14 fw-500 align-center">Password <span style="color:red;">&nbsp;*</span></label>
                                        </div>
                                        <div class="col-sm-9">
                                          <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="password" name="password" value="{{$edit_category_id->password}}" placeholder="Password" autocomplete="off">                                          
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="layout-button mt-25">
                                                <input type="button" class="btn btn-default btn-squared border-normal bg-normal px-20" onclick="window.location.href='{{url('admin/emails_list')}}'" value="Cancel">
