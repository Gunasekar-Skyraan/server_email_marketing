...
<head>
    ...
    <title>Email Marketing - Add Block</title>
                        ...
                        <div id="card_id" class="card card-horizontal card-default card-md mb-4">
                            ...
                            <div class="card-body py-md-30">
                                <div class="horizontal-form">
                                    <form id="some-form" action="{{url('admin/block_list_to_mail')}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                        ...
                                        <div class="col-sm-12" style="margin-top:10px;">
                                          <select class="selectpicker form-control" id="mySelect" multiple>
                                            @foreach($emailcategory as $row)
                                              <option title="{{$row->category_name}}" value="{{$row->id}}" selected>{{$row->category_name}}</option>
                                            @endforeach
                                          </select>
                                  ...
                                  --}}
                                      <div class="form-group row mb-3">
                                        <div class="col-sm-3 d-flex aling-items-center">
                                          <label for="exampleInputUsername2" class="col-form-label color-dark fs-14 fw-500 align-center">Block list <span style="color:red;">&nbsp;*</span></label>
                                        </div>
                                        <div class="col-sm-9">
                                          <div class="form-check-inline h5 text-dark">
                                            ...
                                            <label class="form-check-label" for="flexRadioDefault1" style="font-size: 80%;padding-left:5px;cursor: pointer;">
                                              Add to block Email
                                            </label>
                                          </div>
                                          <div class="form-check-inline h5 text-dark">
                                            ...
                                            <label class="form-check-label" for="flexRadioDefault2" style="font-size: 80%;padding-left:5px;cursor: pointer;">
                                              Remove to Block Email
                                            </label>
                                          </div> 
                                        </div>
                                      </div>
                                      <div id ='Normal' class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" placeholder="Enter the Email to BLock EX: example@gmail.com,example2@gmail.com"  id="normal_desc" name="ques_desc_1" style="height: 100px;" rows="5">{{old('ques_desc_1')}}</textarea>
                                        </div>
                                      </div>
                                      <div id="form-text" class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" placeholder="Enter the Email to Remove BLock EX: example@gmail.com,example2@gmail.com"  id="html_desc" name="ques_desc_2" style="height: 100px;">{{old('ques_desc_2')}}</textarea>
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <div class="col-sm-3">
