...
<head>
    ...
    <title>Email Marketing - Edit Sub Category</title>
                      ...
                      <div class="col-lg-12">
                        <div class="card card-horizontal card-default card-md mb-4">
                            <div class="card-header">
                                <h6>Add Sub Category Form</h6>
                            </div>
                            <div class="card-body py-md-30">
                                <div class="horizontal-form">
                                  @foreach ($edit_sub_category_id as $edit)
                                    <form   role="form" class="forms-sample" action="{{url('Quiz/edit_sub_category_list/'.$edit->id)}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                              ...
                                              <div class="atbd-select ">
                                                  <select name="select-alerts2" id="select-alerts2" class="form-control ">
                                                    <optgroup label="Selected Categories">  
                                                      <option class="text-dark" value="{{$edit->category->id}}"selected>{{$edit->category->category_name}}</option>
                                                    </optgroup>  
                                                    <optgroup label="Available Categories">
                                                      @foreach($category_id as $category)
                                                        @if($category->id !== $edit->category->id)
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex aling-items-center">
                                                <label for="SubCategoryName" class=" col-form-label color-dark fs-14 fw-500 align-center">SubCategory Name <span style="color:red;">&nbsp;*</span></label>
                                            </div>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="SubCategoryName" name="SubCategoryName" value="{{$edit->sub_category_name}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                          <div class="col-sm-3 d-flex aling-items-center">
                                              <label for="SubCategoryDescription" class=" col-form-label color-dark fs-14 fw-500 align-center">SubCategory
                                                  Discription </label>
                                          </div>
                                          <div class="col-sm-9">
                                              <textarea class="form-control" id="SubCategoryDescription" rows="3" name="SubCategoryDescription" placeholder="Sub Category Short Discription" autocomplete="off">{{$edit->sub_category_description}}</textarea>
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                          <div class="col-sm-3 d-flex aling-items-center">
                                          <label for="exampleInputUsername2" class=" col-form-label color-dark fs-14 fw-500 align-center">Sub Category Image Type </label>
                                          </div>
                                          <div class="col-sm-9">
                                        ...
                                        <div  id ='Normal_image_type' class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                              <input type="file" class="form-control ih-medium ip-light radius-xs b-light px-15" accept="Quiz/*" name="file" id="file" autocomplete="off">
                                          </div>
                                        </div>
                                        <div id="url_image_type" class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                              <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" id="file_1" name="url_image" value="@if($edit->image_type == 2){{$edit->sub_category_image}}@endif" autocomplete="off">
                                          </div>
                                        </div>
                                        @if(!empty($edit->sub_category_image))
                                            <div class="form-group row ">
                                              <div class="col-sm-3 d-flex aling-items-center">
                                                <label for="mobile" class=" col-form-label color-dark fs-14 fw-500 align-center">Image Preview<span style="color:red;">&nbsp;*</span></label>
                                              </div>
                                              <div class="col-md-9">
                                                @if($edit->image_type == 1)
                                                  <img src="{{asset($edit->sub_category_image)}}" style="height:70px;width:auto;">
                                                @else
                                                <img src="{{$edit->sub_category_image}}" style="height:70px;width:auto;">
                                                @endif
                                              </div>
                                            </div>
                                          @endif
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                              <div class="layout-button mt-25">
                                                  <input type="button" class="btn btn-default btn-squared border-normal bg-normal px-20" onclick="window.location.href='{{url('Quiz/sub_category_list')}}'" value="Cancel">
