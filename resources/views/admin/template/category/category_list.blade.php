...
<head>
    ...
    <title>Email Marketing - Category List</title>
                        ...
                        <div class="col-lg-12">
                            <div class="breadcrumb-main">
                              <ul class="atbd-breadcrumb nav">
                                ...
                                <li class="atbd-breadcrumb__item">
                                    <span>Template Category List</span>
                                </li>
                              </ul>
                              <div class="action-btn">
                                <a href="{{url('admin/template_add_category')}}" class="btn btn-sm btn-primary btn-add">
                                  <i class="la la-plus"></i> Add New Template Category</a>
                              </div>
                            </div>
                        </div>
                    </div>
                                          ...
                                          <tbody>
                                            @foreach($categorys  as $category)
                                              <tr>
                                                  ...
                                                  <td>
                                                    <div class="userDatatable-inline-title">
                                                      <a href="#" class="text-dark fw-500">
                                                          <h6>{{$category->temp_category_name}}</h6>
                                                      </a>
                                                  </div>
                                                  </td>
                                                  <td>
                                                    ...
                                                    <div class="dropdown dropdown-click" style="padding-left: 25px;">
                                                      ...
                                                      <div class="dropdown-default dropdown-menu bg-dark">
                                                        <div class="dropdown-item" style="padding-left:55px !important;">
                                                            <form action={{url("admin/template_edit_category/".$category->id)}} method="POST">
                                                                {{csrf_field()}}
                                                        ...
                                                        <div class="dropdown-item" style="padding-left:50px !important;">
                                                            <form action={{url("admin/template_delete_category/".$category->id)}} method="POST" style="padding-left:5px;">
                                                              {{csrf_field()}}
                                                  ...
                                                  <td>
                                                    <form action="{{url('admin/template_category_status_update')}}" method="POST">
                                                      @csrf
