...
<head>
    ...
    <title>Email Marketing - Edit Category</title>
                            ...
                            <div class="breadcrumb-main">
                              <ul class="atbd-breadcrumb nav">
                                <li class="atbd-breadcrumb__item">
                                    <a href="{{url('admin/template_category_list')}}">
                            ...
                            <div class="card-body py-md-30">
                                <div class="horizontal-form">
                                  @foreach ($edit_category_id as $edit_category_id)
                                    <form action="{{url('admin/template_edit_category_list/'.$edit_category_id->id)}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex aling-items-center">
                                                <label for="editcatname" class=" col-form-label color-dark fs-14 fw-500 align-center">Category Name <span style="color:red;">&nbsp;*</span></label>
                                            </div>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control ih-medium ip-light radius-xs b-light px-15" name="editcatname" id="editcatname" value="{{$edit_category_id->temp_category_name}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                          <div class="col-sm-3">
                                          ...
                                          <div class="col-sm-9">
                                              <div class="layout-button mt-25">
                                                  <input type="button" class="btn btn-default btn-squared border-normal bg-normal px-20" onclick="window.location.href='{{url('admin/template_category_list')}}'" value="Cancel">
