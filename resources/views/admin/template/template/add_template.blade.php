...
<head>
    ...
    <title>Email Marketing - Add Template</title>
                        ...
                        <div class="card card-horizontal card-default card-md mb-4">
                            ...
                            <div class="card-body py-md-30">
                                <div class="horizontal-form">
                                    <form action="{{url('admin/template.insert')}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                        <div class="form-group row">
                                          <div class="col-sm-3 d-flex aling-items-center">
                                            <label for="select-alerts2" class="col-form-label color-dark fs-14 fw-500 align-center">Template Category</label>
                                          </div>
                                          <div class="col-sm-9">
                                        ...
                                        <div id ='Normal' class="form-group row mb-3">
                                          ...
                                          <div class="col-sm-9">
                                              <textarea class="form-control" placeholder="Leave a comment here"  id="normal_desc" name="ques_desc_1" style="height: 100px;" rows="5">{{old('ques_desc_1')}}</textarea>
                                          </div>
                                        </div>
                                        <div id="form-text" class="form-group row mb-3">
                                          ...
                                          <div class="col-sm-9">
                                              <textarea class="form-control" placeholder="Leave a comment here"  id="html_desc" name="ques_desc_2" style="height: 100px;">{{old('ques_desc_2')}}</textarea>
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                          <div class="col-sm-3">
