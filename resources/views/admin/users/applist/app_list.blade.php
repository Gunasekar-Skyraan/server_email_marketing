...
<head>
    ...
    <title>Email Marketing - Users List</title>
                        ...
                        <div class="col-lg-12">
                            <div class="breadcrumb-main">
                              ...
                              <div class="action-btn">
                                <a href="{{url('admin/add_users')}}" class="btn btn-sm btn-primary btn-add">
                                      ...
                                      <table id="members_list" class="table mb-0 table-bordered">
                                          <thead>
                                              <tr class="userDatatable-header">
                                                  ...
                                                  <th>
                                                      <span class="userDatatable-title">User Email</span>
                                                  </th>
                                                  <th>
                                          ...
                                          <tbody>
                                            @foreach($apps as $app)
                                              <tr>
                                                              ...
                                                              <div class="checkbox-group-wrapper">
                                                                  <div class="checkbox-group d-flex">
                                                                      <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                                          <input class="checkbox" type="checkbox" id="check-grp-{{$app->id}}">
                                                                          <label for="check-grp-{{$app->id}}"></label>
                                                                      </div>
                                                                  </div>
                                                              </div>
                                                          </div>
                                                  ...
                                                  <td>
                                                      <div class="userDatatable-content">{{$app->phone_number}}
                                                      </div>
                                                  </td>
                                                  <td>
                                                      <div class="userDatatable-content">
                                                    ...
                                                    <div class="dropdown dropdown-click" style="padding-left: 25px;">
                                                      ...
                                                      <div class="dropdown-default dropdown-menu bg-dark">
                                                        <div class="dropdown-item" style="padding-left:55px !important;">
                                                          <form action={{url("admin/edit_users/".$app->id)}} method="POST">
                                                            {{csrf_field()}}
                                                        ...
                                                        <div class="dropdown-item" style="padding-left:55px !important;">
                                                          <form action={{url("admin/delete_users/".$app->id)}} method="POST">
                                                            {{csrf_field()}}
                                                  ...
                                                  <td>
                                                    <form action="{{url('admin/users_status_update')}}" method="POST">
                                                      @csrf
