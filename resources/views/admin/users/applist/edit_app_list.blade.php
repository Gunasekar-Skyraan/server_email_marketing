...
<head>
    ...
    <title>Email Marketing - Edit App</title>
    ...
    <link rel="icon" type="QuizSet4/png" sizes="16x16" href="{{asset('img/favicon.png')}}">
</head>
    ...
    <main class="main-content">
                          ...
                          <div class="card card-horizontal card-default card-md mb-4">
                              ...
                              <div class="card-body py-md-30">
                                  <div class="horizontal-form">
                                    @foreach ($edit_app_id as $edit)
                                      <form role="form" action="{{url('admin/edit_users_list/'.$edit->id)}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                              ...
                                              <div class="atbd-select ">
                                                  <select name="category_id" id="category" class="form-control ">
                                                    <optgroup label="Selected Categories">  
                                                      <option class="text-dark" value="{{$edit->category->id ?? 'none'}}"selected>{{$edit->category->category_name ?? 'none'}}</option>
                                                    </optgroup>  
                                                    <optgroup label="Available Categories">
                                                      @foreach($category_id as $category)
                                                        @if($category->id ?? 'none' !== $edit->category->id ?? 'none')
                                                            <option class="text-dark" value="{{$category->id ?? 'none'}}">{{$category->category_name ?? 'none'}}</option>
                                                        @endif
                                                      @endforeach
                                                    </optgroup>
                                        ...
                                        <div class="form-group row mb-25">
                                          <div class="col-sm-3 d-flex aling-items-center">
                                              <label for="inputNameIcon" class=" col-form-label color-dark fs-14 fw-500 align-center">Name <span style="color:red;">&nbsp;*</span></label>
                                          </div>
                                          <div class="col-sm-9">
                                              <div class="with-icon">
                                                  <span class="la-user lar color-gray"></span>
                                                  <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light" id="inputNameIcon" name="name" value="{{$edit->user_name}}" placeholder="Enter a User Name">
                                              </div>
                                          </div>
                                        </div>
                                        <div class="form-group row mb-25">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="with-icon">
                                                    ...
                                                    <input type="email" class="form-control  ih-medium ip-gray radius-xs b-light" id="inputEmailIcon" value="{{$edit->user_email}}" name="email" placeholder="Enter a User Email">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-25">
                                          ...
                                          <div class="col-sm-9">
                                              <input type="number" class="form-control ih-medium ip-gray radius-xs b-light" id="phone_number" value="{{$edit->phone_number}}" name="phone_number" placeholder="Enter a User phone_number">
                                          </div>
                                        </div>
                                        <div class="form-group row mb-25">
                                          <div class="col-sm-3 d-flex aling-items-center">
                                          ...
                                          <div class="col-sm-9">
                                              <div class="checkbox-theme-default custom-checkbox ">
                                                <input class="checkbox" type="checkbox" id="check-1" value="1" name="same_as" @if($edit->same_as_ph == 1) checked @endif>
                                                <label for="check-1">
                                        ...
                                        <div class="form-group row mb-25">
                                          ...
                                          <div class="col-sm-9">
                                            <input type="number" class="form-control ih-medium ip-gray radius-xs b-light" id="whatssapp_number" value="{{$edit->whatsapp_number}}"  name="whatssapp_number" placeholder="Enter a WhatsApp Number">
                                          </div>
                                        </div>
                                        <div class="form-group row mb-25">
                                          <div class="col-sm-3 d-flex aling-items-center">
                                          ...
                                          <div class="col-sm-9">
                                            <div class="radio-horizontal-list d-flex">
                                              <div class="radio-theme-default custom-radio ">
                                                  <input class="radio" type="radio" name="radio-optional" value="Male" id="radio-hl1" @if($edit->gender == 'Male') checked @endif>
                                                  <label for="radio-hl1">
                                                      <span class="radio-text">Male</span>
                                                  </label>
                                              </div>
                                              <div class="radio-theme-default custom-radio ">
                                                  <input class="radio" type="radio" name="radio-optional" value="FeMale" id="radio-hl2" @if($edit->gender == 'FeMale') checked @endif>
                                                  <label for="radio-hl2">
                                        ...
                                        <div  id ='Normal_image_type' class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                              <input type="date" class="form-control ih-medium ip-light radius-xs b-light px-15" name="dob" id="dob" value=@if($edit->age_type == 0) {{$edit->date_of_birth}} @endif  autocomplete="off">
                                          </div>
                                        </div>
                                        <div id="url_image_type" class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                              <input type="number" class="form-control ih-medium ip-light radius-xs b-light px-15" id="age" name="age" value="@if($edit->age_type == 1) {{$edit->age}} @endif" placeholder="18" width="30%" autocomplete="off">
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                          <div class="col-sm-3 d-flex aling-items-center">
                                              <label for="element-text8" class=" col-form-label color-dark fs-14 fw-500 align-center">Pincode </label>
                                          </div>
                                          <div class="col-sm-9">
                                              <input type="number" class="form-control ih-medium ip-light radius-xs b-light px-15" id="element-text8" value="{{$edit->pincode}}" name="Pincode" placeholder="641104" autocomplete="off">
                                          </div>
                                        </div>
      ...
      <script type="text/javascript">
          ...
          $.ajax({
            ...
            success:function(data) 
            {
              ...
              if(data.length > 0 )
              {
                ...
                { 
                    var php_sub_var = {{$edit->sub_category_id}};
                    if(php_sub_var == subcategory.id)
                    {
                      $('#select-search').append('<option class="text-dark" value="'+php_sub_var+'" selected>'+subcategory.sub_category_name+'</option>');
                    }
                    else{
        ...
        success:function(data) 
        {
            ...
            {
              $('#select-search').append('<option class="text-dark" value="0" selected>none</option>');
            }
        }
        })
        });
